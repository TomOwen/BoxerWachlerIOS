...
class DryEyeViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //
         let localfilePath = Bundle.main.url(forResource: "dryeye", withExtension: "html");
