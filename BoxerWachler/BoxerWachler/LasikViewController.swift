...
class LasikViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //
         let localfilePath = Bundle.main.url(forResource: "lasik", withExtension: "html");
