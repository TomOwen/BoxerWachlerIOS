//
//  VisianICLViewController.swift
//  BoxerWachler
//
//  Created by Tom Owen on 4/26/16.
//  Copyright © 2016 Boxer Wachler Vision Institute. All rights reserved.
//
// controller for vision correction 2/16/7

import UIKit

class VisianICLViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let localfilePath = Bundle.main.url(forResource: "visioncorrection", withExtension: "html");
