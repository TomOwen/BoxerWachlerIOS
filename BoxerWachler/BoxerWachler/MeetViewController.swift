...
//  BoxerWachler
//
//  Created by Tom Owen on 4/26/16.
//  Copyright © 2016 Boxer Wachler Vision Institute. All rights reserved.
//

import UIKit

class MeetViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //
         let localfilePath = Bundle.main.url(forResource: "bw_meetdrbrian", withExtension: "html");
         let myRequest = URLRequest(url: localfilePath!);
         WebView.loadRequest(myRequest);
         //
        /*
        let url = NSURL (string: "https://www.google.com/maps?saddr=My%20Location&daddr=465%20N%20Roxbury%20Dr%20#902,%20Beverly%20Hills,%20CA%2090210");
