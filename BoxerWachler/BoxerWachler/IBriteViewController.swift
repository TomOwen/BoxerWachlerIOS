...
class IBriteViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //
         let localfilePath = Bundle.main.url(forResource: "ibrite", withExtension: "html");
