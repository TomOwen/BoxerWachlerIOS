//
//  OutofTownViewController.swift
//  BoxerWachler
//
//  Created by Tom Owen on 5/9/16.
//  Copyright © 2016 Boxer Wachler Vision Institute. All rights reserved.
//

import UIKit

class OutofTownViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //
        let localfilePath = Bundle.main.url(forResource: "outoftown", withExtension: "html");
